      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              // Goal summary card - fixed height
              Container(
                padding: const EdgeInsets.all(16),
              ...
              // Grid view - this takes remaining space
              Expanded(
                    ...
                    if (intervalData is Map<String, dynamic>) {
                      amount =
                          (intervalData['amount'] as num?)?.toDouble() ??
                              amountPerInterval;
                      fromCardId = intervalData['cardId'];
                      toCardId = intervalData['toCardId'];
                        ...
                        await Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (_) => GoalDetailsPage(
                              ...
                              selectedFromCardId: isDeposited ? fromCardId : null,
                              selectedToCardId: isDeposited ? toCardId : null,
                            ),
                          ),
                        );
                      },
